...
function main(){
    ...
    gl.shaderSource(vertShader, document.querySelector("#vertex-shader-3d").text)
    gl.compileShader(vertShader);

    // Process fragment shader
    var fragShader = gl.createShader(gl.FRAGMENT_SHADER);
    gl.shaderSource(fragShader, document.querySelector("#fragment-shader-3d").text);
